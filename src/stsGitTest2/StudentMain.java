...
//		Person 클래스 타입의 변수 p에 자손 클래스 타입의 객체가 들어 있으므로 p.grade, p.department가 
//		동작 될 것이라 생각하지만 부모 클래스 타입의 부모 객체로 잠시 모습이 변해있는 형태이기 때문에 자손 클래스
//		타입의 멤버들을 사용할 수 없음 
//		p.grade = 'A';
//		p.department = "Com";
	}
